...
> = {
  ...
  aiConfidence: { label: "Technical confidence", unit: "score", help: "RTT qualification confidence, 0–100" },
...
const SEED: AlertDraft[] = [
  ...
  },
  {
    ...
    operator: "above",
    value: 90,
    note: "Technical score threshold",
    channels: { toast: true, feed: true },
    source: "watchlist",
  },
  {
    ...
    operator: "above",
    value: 80,
    note: "Monitor model conviction threshold",
  ...
  },
  {
    ...
    operator: "below",
    value: 2250,
    note: "Technical breakdown threshold",
    channels: { toast: true, feed: true },
    source: "watchlist",
  },
];
